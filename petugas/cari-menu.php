                    ...
                    <div class="table-responsive">
                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td><a type='button' href='?page=edit-barang&ProdukID=<?= $data['ProdukID']; ?>' class='btn btn-sm btn-warning'>Edit</a> <a type='button' href='?page=hapus-barang&ProdukID=<?= $data['ProdukID']; ?>' class='btn btn-sm btn-danger'>Delete</a></td>
                                <td>
